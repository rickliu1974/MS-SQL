USE [DW]
GO
/****** Object:  Table [dbo].[EC_Order_PayEasy_tmp]    Script Date: 07/24/2017 14:43:42 ******/
DROP TABLE [dbo].[EC_Order_PayEasy_tmp]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[EC_Order_PayEasy_tmp](
	...
	[cust_addr1] [nvarchar](765) NULL,
	[cust_addr2] [nvarchar](765) NULL,
