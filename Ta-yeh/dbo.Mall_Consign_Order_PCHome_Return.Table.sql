USE [DW]
GO
/****** Object:  Table [dbo].[Mall_Consign_Order_PCHome_Return]    Script Date: 07/24/2017 14:43:44 ******/
DROP TABLE [dbo].[Mall_Consign_Order_PCHome_Return]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Mall_Consign_Order_PCHome_Return](
	[rowid] [int] NOT NULL,
	[ct_no] [nchar](10) NULL,
