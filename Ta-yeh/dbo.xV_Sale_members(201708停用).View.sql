USE [DW]
GO
/****** Object:  View [dbo].[xV_Sale_members(201708°±¥Î)]    Script Date: 08/18/2017 17:43:39 ******/
DROP VIEW [dbo].[xV_Sale_members(201708°±¥Î)]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
Create View [dbo].[xV_Sale_members(201708°±¥Î)]
as
  ...
  select distinct top 1000
         ...
         e_mstno, chg_mst_name, e_rdate, chg_e_sex, chg_e_birth, 
         chg_emp_day, chg_emp_sumym, chg_leave
    from RealTime_SaleData as m left join Fact_pemploy as d on m.area=d.e_no collate Chinese_Taiwan_Stroke_CI_AS 
   where 1=1
     and kind='00005'
     and e_no is not null
