USE [DW]
GO
/****** Object:  Table [dbo].[Mall_Normal_Order_800yaoya_3C]    Script Date: 07/24/2017 14:43:44 ******/
DROP TABLE [dbo].[Mall_Normal_Order_800yaoya_3C]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Mall_Normal_Order_800yaoya_3C](
	[rowid] [int] NOT NULL,
	[ct_no] [nchar](10) NULL,
