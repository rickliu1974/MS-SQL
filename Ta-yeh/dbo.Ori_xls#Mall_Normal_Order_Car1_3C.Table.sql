USE [DW]
GO
/****** Object:  Table [dbo].[Ori_xls#Mall_Normal_Order_Car1_3C]    Script Date: 07/24/2017 14:43:49 ******/
DROP TABLE [dbo].[Ori_xls#Mall_Normal_Order_Car1_3C]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Ori_xls#Mall_Normal_Order_Car1_3C](
