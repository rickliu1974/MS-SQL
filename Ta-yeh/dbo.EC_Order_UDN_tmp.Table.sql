USE [DW]
GO
/****** Object:  Table [dbo].[EC_Order_UDN_tmp]    Script Date: 07/24/2017 14:43:43 ******/
DROP TABLE [dbo].[EC_Order_UDN_tmp]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[EC_Order_UDN_tmp](
	[rowid] [int] IDENTITY(1,1) NOT NULL,
	[F1] [nvarchar](255) NULL,
	[F2] [varchar](3) NOT NULL,
