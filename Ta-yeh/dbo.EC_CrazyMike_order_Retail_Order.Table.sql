USE [DW]
GO
/****** Object:  Table [dbo].[EC_CrazyMike_order_Retail_Order]    Script Date: 07/24/2017 14:43:40 ******/
DROP TABLE [dbo].[EC_CrazyMike_order_Retail_Order]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[EC_CrazyMike_order_Retail_Order](
	[rowid] [int] NOT NULL,
	[ct_no] [nchar](10) NULL,
