USE [DW]
GO
/****** Object:  Table [dbo].[EC_Consign_Order_Yahoo_Reject]    Script Date: 07/24/2017 14:43:39 ******/
DROP TABLE [dbo].[EC_Consign_Order_Yahoo_Reject]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[EC_Consign_Order_Yahoo_Reject](
	[rowid] [int] NOT NULL,
	[ct_no] [nchar](10) NULL,
