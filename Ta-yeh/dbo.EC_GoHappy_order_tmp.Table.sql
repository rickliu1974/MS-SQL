USE [DW]
GO
/****** Object:  Table [dbo].[EC_GoHappy_order_tmp]    Script Date: 07/24/2017 14:43:41 ******/
DROP TABLE [dbo].[EC_GoHappy_order_tmp]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[EC_GoHappy_order_tmp](
	...
	[F6] [nvarchar](4000) NULL,
	[F7] [nvarchar](4000) NULL,
	[F8] [nvarchar](4000) NULL,
	[F9] [nvarchar](4000) NULL,
