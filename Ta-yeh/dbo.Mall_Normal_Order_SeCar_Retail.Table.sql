USE [DW]
GO
/****** Object:  Table [dbo].[Mall_Normal_Order_SeCar_Retail]    Script Date: 07/24/2017 14:43:45 ******/
DROP TABLE [dbo].[Mall_Normal_Order_SeCar_Retail]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Mall_Normal_Order_SeCar_Retail](
	[rowid] [int] NOT NULL,
	[ct_no] [nchar](10) NULL,
