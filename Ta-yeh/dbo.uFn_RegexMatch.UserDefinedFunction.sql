USE [DW]
GO
/****** Object:  UserDefinedFunction [dbo].[uFn_RegexMatch]    Script Date: 07/24/2017 14:44:01 ******/
...
GO
CREATE FUNCTION [dbo].[uFn_RegexMatch]
    (
...
Desc: 檢查字串的規則是否相符，正確回傳 1, 不正確回傳 0

The uFn_RegexMatch returns True or False, indicating if the regular expression matches (part of) the string. (It returns null if there is an error).
