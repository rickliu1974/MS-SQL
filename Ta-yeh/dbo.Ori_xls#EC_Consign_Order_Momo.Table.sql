USE [DW]
GO
/****** Object:  Table [dbo].[Ori_xls#EC_Consign_Order_Momo]    Script Date: 07/24/2017 14:43:47 ******/
DROP TABLE [dbo].[Ori_xls#EC_Consign_Order_Momo]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Ori_xls#EC_Consign_Order_Momo](
