USE [DW]
GO
/****** Object:  UserDefinedFunction [dbo].[xFn_Count_Split_StrByDelimiter]    Script Date: 07/24/2017 14:44:01 ******/
...
GO
CREATE FUNCTION [dbo].[xFn_Count_Split_StrByDelimiter](@String VARCHAR(8000), @Delimiter CHAR(1))     
  RETURNS INT    
AS 
BEGIN     
