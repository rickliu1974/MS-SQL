USE [DW]
GO
/****** Object:  View [dbo].[uV_RPT_13011]    Script Date: 08/18/2017 17:43:39 ******/
DROP VIEW [dbo].[uV_RPT_13011]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
Create View [dbo].[uV_RPT_13011]
as
...
--         Convert(Varchar(2), month(in_date)) Collate Chinese_PRC_BIN as UBI_Month, -- 發票所屬月
    ...
    from SYNC_TA13.dbo.pinvo m
         left join SYNC_TA13.dbo.pinvodt d
