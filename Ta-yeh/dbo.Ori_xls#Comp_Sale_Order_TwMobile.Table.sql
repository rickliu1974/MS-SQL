USE [DW]
GO
/****** Object:  Table [dbo].[Ori_xls#Comp_Sale_Order_TwMobile]    Script Date: 07/24/2017 14:43:47 ******/
DROP TABLE [dbo].[Ori_xls#Comp_Sale_Order_TwMobile]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Ori_xls#Comp_Sale_Order_TwMobile](
