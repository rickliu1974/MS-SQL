USE [DW]
GO
/****** Object:  StoredProcedure [dbo].[zNew_uSP_ETL_Cust_WeekSale_Stock]    Script Date: 07/24/2017 14:44:00 ******/
DROP PROCEDURE [dbo].[zNew_uSP_ETL_Cust_WeekSale_Stock]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE Proc [dbo].[zNew_uSP_ETL_Cust_WeekSale_Stock](@sDB Varchar(10) = 'TA13')
as
begin
  /*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
