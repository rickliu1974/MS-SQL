USE [DW]
GO
/****** Object:  Table [dbo].[Ori_xls#Combine_Lan_Orders_CRAZYMILK]    Script Date: 07/24/2017 14:43:46 ******/
DROP TABLE [dbo].[Ori_xls#Combine_Lan_Orders_CRAZYMILK]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Ori_xls#Combine_Lan_Orders_CRAZYMILK](
	...
	[xlsFileName] [varchar](18) NOT NULL,
