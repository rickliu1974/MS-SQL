USE [DW]
GO
/****** Object:  Table [dbo].[Comp_EC_Order_SuperMarket]    Script Date: 07/24/2017 14:43:37 ******/
DROP TABLE [dbo].[Comp_EC_Order_SuperMarket]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Comp_EC_Order_SuperMarket](
