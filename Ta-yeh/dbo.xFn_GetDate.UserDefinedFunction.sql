USE [DW]
GO
/****** Object:  UserDefinedFunction [dbo].[xFn_GetDate]    Script Date: 07/24/2017 14:44:01 ******/
DROP FUNCTION [dbo].[xFn_GetDate]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
Create Function [dbo].[xFn_GetDate](@Kind Int = 0, @vDate Varchar(10) = '', @AddDate Int=1)
