USE [DW]
GO
/****** Object:  Table [dbo].[Ori_xls#EC_Order_ETmall]    Script Date: 07/24/2017 14:43:48 ******/
DROP TABLE [dbo].[Ori_xls#EC_Order_ETmall]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Ori_xls#EC_Order_ETmall](
