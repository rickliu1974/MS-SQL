USE [DW]
GO
/****** Object:  View [dbo].[xV_RPT_13011(201708停用)]    Script Date: 08/18/2017 17:43:39 ******/
DROP VIEW [dbo].[xV_RPT_13011(201708停用)]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
Create View [dbo].[xV_RPT_13011(201708停用)]
as
...
--         Convert(Varchar(2), month(in_date)) Collate Chinese_PRC_BIN as UBI_Month, -- 發票所屬月
         ...
         case
           ...
           then Convert(Char(2), in_frm) + -- 格式代號
                ...
                '#BBBBB#'+ -- 流水號
                Convert(Char(3), Convert(Varchar(4), year(in_date)-1911) Collate Chinese_PRC_BIN) + -- 資料所屬年 民國年
                Substring(Convert(Char(3), Convert(Varchar(2), month(in_date)) Collate Chinese_PRC_BIN +100), 2, 2)+ -- 資料所屬月份
    ...
    from TYEIPDBS2.LYTDBTA13.dbo.pinvo m
         left join TYEIPDBS2.LYTDBTA13.dbo.pinvodt d
