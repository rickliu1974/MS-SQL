USE [DW]
GO
/****** Object:  Table [dbo].[Ori_xls#Combine_Lan_Orders_PAYEASY]    Script Date: 07/24/2017 14:43:46 ******/
DROP TABLE [dbo].[Ori_xls#Combine_Lan_Orders_PAYEASY]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Ori_xls#Combine_Lan_Orders_PAYEASY](
	...
	[xlsFileName] [varchar](16) NOT NULL,
