USE [DW]
GO
/****** Object:  Table [dbo].[Mall_Consign_Order_PCHome_Reject]    Script Date: 07/24/2017 14:43:44 ******/
DROP TABLE [dbo].[Mall_Consign_Order_PCHome_Reject]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Mall_Consign_Order_PCHome_Reject](
	[rowid] [int] NOT NULL,
	[ct_no] [nchar](10) NULL,
