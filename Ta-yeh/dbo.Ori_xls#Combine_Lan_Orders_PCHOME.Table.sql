USE [DW]
GO
/****** Object:  Table [dbo].[Ori_xls#Combine_Lan_Orders_PCHOME]    Script Date: 07/24/2017 14:43:46 ******/
DROP TABLE [dbo].[Ori_xls#Combine_Lan_Orders_PCHOME]
GO
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[Ori_xls#Combine_Lan_Orders_PCHOME](
	...
	[xlsFileName] [varchar](15) NOT NULL,
