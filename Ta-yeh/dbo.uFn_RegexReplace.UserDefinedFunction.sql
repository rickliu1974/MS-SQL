USE [DW]
GO
/****** Object:  UserDefinedFunction [dbo].[uFn_RegexReplace]    Script Date: 08/18/2017 17:43:41 ******/
...
RETURNS VARCHAR(max)
/*The uFn_RegexReplace function takes three string parameters. The pattern (the regular expression) the replacement expression, and the subject string to do the manipulation to.
